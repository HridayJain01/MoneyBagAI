...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> notFound(FeignException.NotFound ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, "Referenced account or transaction data was not found", req);
    }

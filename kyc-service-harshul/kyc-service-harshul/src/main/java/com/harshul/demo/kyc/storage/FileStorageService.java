...
public interface FileStorageService {
    ...
    List<KycSessionEntity> findPendingSessions(String externalUserId);
    List<KycSessionEntity> findSessions(String externalUserId, DocumentType documentType);
    void deleteFrames(String sessionId);

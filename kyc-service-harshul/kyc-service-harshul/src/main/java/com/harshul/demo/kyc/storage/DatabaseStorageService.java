...
public class DatabaseStorageService implements FileStorageService{
    ...
    @Override public void deleteFrames(String sessionId) { capturedFrameRepository.deleteBySessionId(sessionId); }
    ...
    @Override public List<KycSessionEntity> findPendingSessions(String externalUserId) {
        return sessionRepository.findByExternalUserIdAndStatusInOrderByCreatedAtDesc(
                externalUserId,
    ...
    @Override public List<KycSessionEntity> findSessions(String externalUserId, DocumentType documentType) {
        if (documentType == null) return sessionRepository.findByExternalUserIdOrderByCreatedAtDesc(externalUserId);
        return sessionRepository.findByExternalUserIdAndDocumentTypeOrderByCreatedAtDesc(externalUserId, documentType);
    }

...
CREATE TABLE clearing_instructions (
    ...
    CONSTRAINT uk_clearing_external UNIQUE (rail, external_reference),
...
VALUES ('00000000-0000-0000-0000-000000000001', NULL, 'RTGS', NULL, 'INR', 200000.0000, NULL, NULL, 1000000.0000, 100, TRUE, CURRENT_TIMESTAMP);

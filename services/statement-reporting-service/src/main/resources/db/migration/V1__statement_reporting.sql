...
CREATE TABLE transaction_read_models (
  ...
  amount DECIMAL(19,2) NOT NULL, fee_amount DECIMAL(19,2) NOT NULL DEFAULT 0, currency CHAR(3) NOT NULL,
...
CREATE TABLE statement_requests (
  ...
  version_no BIGINT NOT NULL DEFAULT 0, created_at TIMESTAMP(6) NOT NULL, updated_at TIMESTAMP(6) NOT NULL,
...
CREATE TABLE generated_statement_files (
  ...
  content_type VARCHAR(100) NOT NULL, file_name VARCHAR(255) NOT NULL, file_size_bytes BIGINT NOT NULL,
...
CREATE TABLE report_schedules (
  ...
  next_run_at TIMESTAMP(6) NOT NULL, active BOOLEAN NOT NULL, last_run_at TIMESTAMP(6), version_no BIGINT NOT NULL DEFAULT 0,
